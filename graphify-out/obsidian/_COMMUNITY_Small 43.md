...
- [[Get available BOMs for Material Request_1]] - rationale - /home/ubuntu/frappe-bench-new/apps/warehousesuite/warehousesuite/warehousesuite/page/pow_dashboard/pow_dashboard.py
...
```dataview
TABLE source_file, type FROM #community/Small_43
SORT file.name ASC
```
...
## Top bridge nodes
- [[get_available_boms()]] - degree 3, connects to 1 community