...
## Connections
- [[Create a Material Transfer for Manufacture Stock Entry.      Args         wo_na]] - `rationale_for` [EXTRACTED]
- [[Create a Material Transfer for Manufacture Stock Entry.      Args         wo_na_2]] - `rationale_for` [EXTRACTED]
