# Graph Report - /home/ubuntu/frappe-bench-new/apps/warehousesuite  (2026-04-16)

## Corpus Check
- 110 files · ~60,000 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1650 nodes · 3136 edges · 72 communities detected
...
Cohesion: 0.02
Nodes (344): API / Service Layer Architecture, Batch/Serial + Desk Restriction Plan, Batch & Serial Number Support, Item Inquiry Feature, Ac(), Ad(), ae(), af() (+336 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (209): _1(), A_(), a1(), Ac(), ag(), Ai(), aj(), Ak() (+201 more)
...
Cohesion: 0.04
Nodes (18): da(), h0(), it(), iv(), m0(), o0(), p0(), Pi() (+10 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (91): _apply_substitutions_to_stock_entry(), _apply_work_order_item_substitutions(), _compose_description_with_original(), create_work_order(), get_alternative_items(), _get_alternative_items_for(), get_bom_for_item(), _get_item_availability() (+83 more)

### Community 5 - "Community 5"
Cohesion: 0.04
Nodes (12): Bf, componentDidCatch(), Ec(), fw, Gn, Lc(), ow, Sn() (+4 more)
...
Cohesion: 0.05
Nodes (13): _a, a0, bv(), hv(), L0(), N0(), Ph(), qf() (+5 more)

### Community 8 - "Community 8"
Cohesion: 0.05
Nodes (44): create_pow_work_order(), get_bom_details(), get_boms_for_item(), get_item_alternatives(), get_manufacture_items(), get_mfg_default_warehouses(), get_pending_pow_work_orders(), get_wo_material_shortfall() (+36 more)
...
Cohesion: 0.67
Nodes (3): create_transfer_stock_entry(), Create stock entry for transfer (source -> in-transit) with proper stock ledger, Create stock entry for transfer (source -> in-transit) with proper stock ledger
...
Cohesion: 0.67
Nodes (3): get_companies(), Get all companies for selection, Get all companies for selection

### Community 44 - "Community 44"
Cohesion: 0.67
Nodes (3): generate_zpl_label(), Generate ZPL code for a single label matching the label design, Generate ZPL code for a single label matching the label design

### Community 45 - "Community 45"
Cohesion: 0.67
Nodes (3): get_items_for_dropdown(), Get items for dropdown with item_code:item_name format and optional stock filter, Get items for dropdown with item_code:item_name format and optional stock filter
...
Cohesion: 0.67
Nodes (3): get_pow_stock_counts(), Get POW Stock Counts for the current user or session, Get POW Stock Counts for the current user or session
...
Cohesion: 0.67
Nodes (3): debug_stock_entry_warehouses(), Debug function to check warehouse information in a stock entry (System Manager o, Debug function to check warehouse information in a stock entry (System Manager o
...
## Knowledge Gaps
- **315 isolated node(s):** `Seed Stock Entry Types if they don't exist.`, `Website page context for `/pow` — React POW shell; requires logged-in user.  	Gu`, `Boot payload for the Vite dev shell (`frontend/`). Requires desk-style session +`, `Sales Order pending-delivery reports for POW dashboard.  Correctness notes (vs r`, `SQL expression: effective warehouse for a sales order line.` (+310 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **Thin community `Community 51`** (2 nodes): `item.js`, `refresh()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 52`** (2 nodes): `Technical Handbook (Inner)`, `Technical Handbook (Root)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 53`** (2 nodes): `Psychological Handbook (Inner)`, `Psychological Handbook (Root)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 54`** (2 nodes): `stock_entry.js`, `refresh()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 55`** (1 nodes): `vite-env.d.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 56`** (1 nodes): `index.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 57`** (1 nodes): `hooks.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 58`** (1 nodes): `Get WMSuite settings as dictionary`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 59`** (1 nodes): `Check if user can bypass value difference restrictions`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 60`** (1 nodes): `Check if user has submission permission`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 61`** (1 nodes): `Convert submitted stock count to stock reconciliation`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 62`** (1 nodes): `Get all items with stock in the selected warehouse`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 63`** (1 nodes): `Convert submitted stock count to stock reconciliation`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 64`** (1 nodes): `Get all items with stock in the selected warehouse`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 65`** (1 nodes): `QZ Tray Integration`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 66`** (1 nodes): `Material Consumption Reconciliation Report`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 67`** (1 nodes): `Warehouse Performance Report`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 68`** (1 nodes): `Desk Stock Entry Restriction`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 69`** (1 nodes): `FIFO/FEFO Picking Enforcement`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 70`** (1 nodes): `Batch Stock Ageing Report`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 71`** (1 nodes): `Barcode Scan Input`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `POWStockConcern` connect `Community 9` to `Community 6`?**
