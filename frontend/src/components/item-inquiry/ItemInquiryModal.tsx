		...
		<div className="fixed inset-0 z-50 bg-white flex flex-col animate-fade-in">
			...
			<header className="bg-slate-900 text-white shrink-0">
				<div className="flex items-center gap-3 px-3 py-2 pt-[max(0.5rem,env(safe-area-inset-top))]">
					<button onClick={selectedItem ? clearSelection : onClose} className="w-9 h-9 flex items-center justify-center hover:bg-slate-800 rounded touch-manipulation">
							...
							<div className="px-3 py-3 bg-white border-b border-slate-200">
								<div className="flex items-start gap-3">
									...
									<div className="min-w-0 flex-1">
										...
										<button onClick={() => setShowPrintLabels(true)} className="mt-2 flex items-center gap-1.5 px-2.5 py-1.5 bg-slate-700 hover:bg-slate-800 text-white text-[10px] font-bold rounded touch-manipulation">
