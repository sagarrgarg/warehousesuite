	...
	return (
		<div className="fixed inset-0 z-50 bg-white flex flex-col animate-fade-in">
			...
			<div className="px-3 py-2 border-b border-slate-200 bg-slate-50 shrink-0">
				...
				{searchErrorText && (
					<p className="mt-1.5 max-w-4xl mx-auto text-[11px] text-red-600 px-1 whitespace-pre-wrap break-words" role="alert">
						{searchErrorText}
					</p>
				)}

				{searchTerm.length >= 2 && !selectedItem && searchResults.length > 0 && (
					<div className="mt-1.5 max-w-4xl mx-auto bg-white border border-slate-200 rounded overflow-hidden max-h-48 overflow-y-auto">
