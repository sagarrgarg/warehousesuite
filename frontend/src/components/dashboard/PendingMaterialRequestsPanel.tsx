    ...
    <div className="flex flex-col h-full bg-white">
      ...
      <div className="flex items-center justify-between px-3 py-1.5 bg-slate-800 text-white shrink-0">
        ...
        {onRaise && (
          <button
            onClick={onRaise}
            className="flex items-center gap-0.5 text-[10px] font-bold text-white bg-emerald-500 hover:bg-emerald-400 active:bg-emerald-600 rounded px-2.5 py-1 transition-colors cursor-pointer touch-manipulation shadow-sm shadow-emerald-900/30"
          >
      ...
      {/* Column header */}
      <div className="flex items-center px-3 py-1 bg-slate-50 border-b border-slate-200 text-[9px] font-semibold text-slate-400 uppercase tracking-wider shrink-0">
